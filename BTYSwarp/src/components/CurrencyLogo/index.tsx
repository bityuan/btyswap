...
export default function CurrencyLogo({
  ...
  if (currency === ETHER) {
    // 私有链2999使用BTY图标，其他链使用BNB图标
    const iconSrc = chainId === 2999 as any ? "/images/coins/bty.png" : "/images/coins/bnb.png"
    return <StyledBnbLogo src={iconSrc} size={size} style={style} />
  }
