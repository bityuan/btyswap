...
import { ChainId, Currency, currencyEquals, ETHER, Token } from '@btyswap-libs/sdk'
  ...
  return (
    <AutoColumn gap="md">
      <AutoRow>
        ...
        <QuestionHelper text={t('theseTokensCommonlyPaired')} />
      </AutoRow>
      <AutoRow gap="4px">
        <BaseWrapper
          onClick={() => {
        ...
        >
          ...
          <Text>{chainId === 2999 as any ? 'BTY' : 'BNB'}</Text>
        </BaseWrapper>
