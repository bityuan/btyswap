                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {chainId === 2999 as any ? 'Receive WBTY' : t('receiveWBNB')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? (chainId === 2999 as any ? 'BTY' : 'BNB') : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? (chainId === 2999 as any ? 'BTY' : 'BNB') : currencyIdB}`}
                            >
                              {chainId === 2999 as any ? 'Receive BTY' : t('receiveBNB')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
              ...
              {pair && (
                <div style={{ padding: '24px' }}>
                  <Flex justifyContent="space-between" mb="8px">
                    Price:
                    <div>
                      1 {getTokenSymbol(currencyA)} = {tokenA ? pair.priceOf(tokenA).toSignificant(6) : '-'} {getTokenSymbol(currencyB)}
                    </div>
                  </Flex>
                  <Flex justifyContent="space-between">
                    <div />
                    <div>
                      1 {getTokenSymbol(currencyB)} = {tokenB ? pair.priceOf(tokenB).toSignificant(6) : '-'} {getTokenSymbol(currencyA)}
                    </div>
                  </Flex>
                </div>
              )}
