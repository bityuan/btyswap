...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@btyswap-libs/sdk'
...
describe('utils', () => {
  describe('#getBityuanScanLink', () => {
    it('correct for tx', () => {
      expect(getBityuanScanLink(1, 'abc', 'transaction')).toEqual('https://bscscan.com/tx/abc')
    })
    it('correct for token', () => {
      expect(getBityuanScanLink(1, 'abc', 'token')).toEqual('https://bscscan.com/token/abc')
    })
    it('correct for address', () => {
      expect(getBityuanScanLink(1, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
    it('unrecognized chain id defaults to mainnet', () => {
      expect(getBityuanScanLink(2, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
    it('ropsten', () => {
      expect(getBityuanScanLink(3, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
    it('enum', () => {
      expect(getBityuanScanLink(ChainId.MAINNET, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
    it('private chain 2999', () => {
      expect(getBityuanScanLink(2999, 'abc', 'address')).toEqual('https://mainnet.bityuan.com/address/abc')
    })
  })
